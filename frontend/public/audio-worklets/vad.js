...
function FFT(size) {
  ...
  // Find size-1 power of two
  var power = 0;
  for (var t = 1; this.size > t; t <<= 1)
    power++;

  // Calculate bit-reversal patterns
  this._width = power % 2 === 0 ? power - 1 : power;

  // Pre-calculate bit-reversal patterns
  var bitrev = new Array(1 << this._width);
...
FFT.prototype.toComplexArray = function toComplexArray(input, storage) {
  var res = storage || new Array(this._csize);
